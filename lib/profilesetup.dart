...
// Class Stateful สำหรับทำงานแบบโต้ตอบ
class Profilesetup extends StatefulWidget {
  @override
  State<Profilesetup> createState() => _ProfileSetupPageState();
}

class _ProfileSetupPageState extends State<Profilesetup> {
  // 1) ประกาศตัวแปร formKey เป็น GlobalKey เพื่อตรวจสอบการรับค่าที่ผู้ใช้ป้อนผ่านฟอร์ม
  final _formKey = GlobalKey<FormState>();

  // 2) ประกาศตัวแปร TextEditingController เพื่อรับค่าที่ผู้ใช้ป้อนผ่านฟอร์ม
  ...
  // 3) สร้างฟังก์ชันสำหรับการเลือกวันที่เพื่อไปเรียกใช้
  ...
  Future<void> _uploadProfile(String uid) async {
    try {
      ...
      if (_profileImage != null) {
        final storageRef =
            FirebaseStorage.instance.ref().child('profilespapawin/$uid.jpg');
        if (kIsWeb) {
      ...
      await _dbRef.child('userspapwin/$uid').set({
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  decoration:
                      InputDecoration(labelText: 'คำนำหน้าชื่อ (Prefix)'),
                  items: prefix
